...
You can view the default configuration here: [https://github.com/rawilk/laravel-settings/blob/{branch}/config/settings.php](https://github.com/rawilk/laravel-settings/blob/{branch}/config/settings.php)
